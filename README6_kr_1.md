...
# Тернарный поиск
### Определение 
Алгоритм тернарного поиска (Ternary Search) — это алгоритм поиска в отсортированном массиве, который делит область поиска на три равные части и рекурсивно выбирает одну из них для дальнейшего поиска, исключая две оставшиеся части.
### Объяснение работы алгоритма:
• Инициализация границ: Устанавливаются начальные границы поиска - low (начальный индекс) и high (конечный индекс) массива (low = 0, high = len(arr) - 1)

• Вычисление точек разделения: Массив делится на три равные части с помощью двух точек разделения - third1 и third2 (third1 = low + (high - low) // 3, third2 = high - (high - low) // 3)

• Проверка точек разделения: Сравниваются значения в точках third1 и third2 с искомым ключом. Если совпадение найдено, возвращается соответствующий индекс
### Временная сложность 
Временная сложность — O(log₃n)
### Почему 
Деление на три части: На каждой итерации область поиска уменьшается в 3 раза. Количество итераций: В худшем случае требуется log₃n итераций.
#
