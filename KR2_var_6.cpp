=== Генетический алгоритм: поиск строки с максимальным количеством единиц ===
Введите размер популяции: 100 
Введите количество поколений: 50
...
=== РЕЗУЛЬТАТ ===
Лучшая найденная строка: 1111111111
